...
$str .= "<div style ='border: 2px solid green; padding-top:50px; border-radius:34px; background-color: white;' class='classBox'>
									
								
<a style='margin-top: 30px;' href = 'classRoom.php?classCode=$code'> <h3>$className </h3></a> 
Section: $section
<br>
$subject
<br>
...
public function loadEnrolledClasses()
{
	...
	if (mysqli_num_rows($data_query) > 0) {
		while ($row = mysqli_fetch_array($data_query)) {
			...
			$str .= "<div style ='border: 2px solid green; padding-top:40px; border-radius:34px; background-color: white;'class='EnrolledclassBox'>
