...
<div class=Wrapper2  >
    ...
    <div style="border:2px solid green; background-color: #e6ffe6;" class="user_details cloumn">
        ...
        <div class="assignment_box">
            ...
            <!-- NEW FEATURE -->
            <a href="#" id="assignmentBtn"><i class="far fa-file-word" style='margin-right: 5px;'></i>File Post </a>


            
            <a href="AssignTeacher.php" id="assignmentBtn"><i class="far fa-file-word" style='margin-right: 5px;'></i>Assignment </a>
            <a href="chat/spachat.php?chatCode=<?= $chat_secret ?>"><i class="fas fa-comments" style='margin-right: 5px;'></i>Chat</a>
    ...
    <div style="border:2px solid green; background-color: #e6ffe6;" class="people_column">
    ...
    <div style="border:2px solid green; background-color: #e6ffe6;" class="main_column">
        <div id="first">
