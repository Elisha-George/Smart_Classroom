...
<main class="profile-body" >
    ...
    <div  style="border:2px solid green; background-color: #e6ffe6;"class="modal">
    ...
    <section  style="border:2px solid green; background-color: #e6ffe6;" class="side-bar">
    ...
    <section  style="border:2px solid green; background-color: #e6ffe6;" class="profile">
